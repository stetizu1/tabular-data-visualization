...
export const EMPTY_DATA_TEXT = {
  ...
  helpDialog: {
    ...
    file: `You use applications with your own datasets, JSON or CSV files. Files needs to have the right format, for JSON it is the array of the same objects with only simple values.`,
    viewsHelp: `To get more information about a specific view, you can look at his specific help, which can be found in his header.`,
